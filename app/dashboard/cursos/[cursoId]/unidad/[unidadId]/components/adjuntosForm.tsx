...
import { Archivos, Curso } from "@prisma/client";
...
const AdjuntosForm: FC<AdjuntosFormProps> = ({ cursoId, initialData }) => {
  ...
  const onSubmit = async (values: z.infer<typeof formSchema>) => {
    try {
      await axios.post(`/api/courses/${cursoId}/attachments`, values);
  ...
  const onDelete = async (id: string) => {
    try {
      setDeletingId(id);
      await axios.delete(`/api/courses/${cursoId}/attachments/${id}`);
